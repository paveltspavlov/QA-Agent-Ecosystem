---
name: report-creator
description: Consumes Playwright test execution data (JSON reporter output, execution logs, bug data) and produces comprehensive HTML and markdown test execution reports with executive summaries, pass/fail tables, bug lists, and recommendations.
