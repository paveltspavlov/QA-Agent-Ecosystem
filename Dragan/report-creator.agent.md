...
- Save the complete results of your work to `.vscode/current_task/<NN>-report-creator.md`, where `<NN>` is the two-digit step number assigned by qa-manager (use `00` when run standalone).
