...
#
# Copies every *.agent.md from .github/agents/ into ~/.copilot/agents/ so the
# agents are available in all workspaces, not just this repo.
#
# Usage:
#   ./install_copilot_agents.sh           # install agents
#   ./install_copilot_agents.sh --force   # overwrite without prompting
