...
- File: [e.g., designs/feature-login-v2.png]
- Or Figma link: [https://figma.com/file/...]
- Or PDF wireframe: [e.g., designs/wireframes.pdf]

## Pages / Sections to Compare

- [e.g., "Login page (desktop 1280px and mobile 375px)"]
- [e.g., "Password reset modal"]
- [e.g., "Dashboard header"]
